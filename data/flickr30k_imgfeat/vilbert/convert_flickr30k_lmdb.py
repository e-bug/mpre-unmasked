...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='/data/bugliarello.e/data/flickr30k/flickr30k_imgfeat')
    parser.add_argument('--outdir', type=str, default='/data/bugliarello.e/data/flickr30k/flickr30k_imgfeat/vilbert')
