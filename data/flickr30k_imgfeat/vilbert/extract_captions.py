...
def parse_args():
    ...
    parser.add_argument('--infile', type=str, default='/data/bugliarello.e/data/flickr30k/dataset_flickr30k.json')
    parser.add_argument('--outdir', type=str, default='/data/bugliarello.e/data/flickr30k/flickr30k_annotations/vilbert')
