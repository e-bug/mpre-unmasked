...
def load_image_ids(img_root, group_id, total_group):
    ...
    image_data = {}
    image_id = {}
    with open('../annotations/detections/refcocog_umd/res101_coco_minus_refer_notime_dets_36.json') as f:
...
if __name__ == '__main__':
    ...
    args.outfile = "%s_obj%d-%d.tsv.%d" % ('refcocog_umd_gt36', MIN_BOXES, MAX_BOXES, args.group_id)
    ...
    image_ids, bbox, num_bbox = load_image_ids(args.imgroot, args.group_id, args.total_group)
