...
def load_image_ids(img_root, group_id, total_group):
    ...
    image_data = {}
    image_id = {}
    with open('../annotations/detections/refcocog_umd/res101_coco_minus_refer_notime_dets.json') as f:
...
if __name__ == '__main__':
    ...
    args.outfile = "%s_obj%d-%d.tsv.%d" % ('refcocog_umd_gt', MIN_BOXES, MAX_BOXES, args.group_id)
