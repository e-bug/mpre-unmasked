...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='/data/bugliarello.e/data/refer/refcocog_umd_imgfeat')
    parser.add_argument('--outdir', type=str, default='/data/bugliarello.e/data/refer/refcocog_umd_imgfeat/vilbert')
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.infiles = [os.path.join(args.indir, "refcocog_umd_obj36-36.tsv")]
    args.outpath = os.path.join(args.outdir, "%s_feat.lmdb" % 'refcocog_umd')
