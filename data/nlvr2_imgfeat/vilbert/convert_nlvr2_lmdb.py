...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='/data/bugliarello.e/data/nlvr/nlvr2/nlvr2_imgfeat')
    parser.add_argument('--outdir', type=str, default='/data/bugliarello.e/data/nlvr/nlvr2/nlvr2_imgfeat/vilbert')
