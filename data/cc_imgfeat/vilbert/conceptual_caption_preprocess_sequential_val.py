...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        #self.num_file = 30
        self.name = os.path.join(corpus_path, 'valid_obj36-36.clean.tsv') # FIXME conceptual_caption_trainsubset_resnet101_faster_rcnn_genome.tsv.%d')
        ...
        with open(os.path.join(corpus_path, 'caption_valid.json')) as f:
...
if __name__ == '__main__':
    ...
    LMDBSerializer.save(ds1, os.path.join(corpus_path, 'vilbert/validation_feat_all.lmdb'))
