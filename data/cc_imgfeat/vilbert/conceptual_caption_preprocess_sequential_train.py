...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        #self.num_file = 30
        self.name = os.path.join(corpus_path, 'train_obj36-36.clean.tsv')
        ...
        with open(os.path.join(corpus_path, 'caption_train.json')) as f:
...
if __name__ == '__main__':
    ...
    LMDBSerializer.save(ds1, os.path.join(corpus_path, 'vilbert/training_feat_all.lmdb'))
