...
def get_annotations(infile, save_path, split):
    ...
    if split == 'test1k':
        ids = set([int(i.strip()) for i in open('../test1k.ids').readlines()])
...
def parse_args():
    ...
    parser.add_argument('--infile', type=str, default='/data/bugliarello.e/data/mscoco/annotations/dataset_coco.json')
    parser.add_argument('--outdir', type=str, default='/data/bugliarello.e/data/mscoco/annotations/vilbert')
