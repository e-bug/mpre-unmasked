...
::
    >>> python -m torch.distributed.launch --nproc_per_node=NUM_GPUS_YOU_HAVE
               ...
               arguments of your training scripts)
...
::
    >>> python -m torch.distributed.launch --nproc_per_node=NUM_GPUS_YOU_HAVE
               ...
               and all other arguments of your training scripts)
Node 2:
::
    >>> python -m torch.distributed.launch --nproc_per_node=NUM_GPUS_YOU_HAVE
...
``LOCAL_RANK``. This behavior is enabled when you launch the scripts with
...
def parse_args():
    ...
    #                          "If set to True, the scripts will not pass "
    #                          "--local_rank as argument, and will instead set LOCAL_RANK.")

    # positional
    parser.add_argument("training_script", type=str,
                        help="The full path to the single GPU training "
                             "program/scripts to be launched in parallel, "
