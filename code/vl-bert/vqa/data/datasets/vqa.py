...
class VQA(Dataset):
    def __init__(self, image_set, root_path, data_path, answer_vocab_file, use_imdb=True,
        ...
        vqa_question = {
            "train2014": "vqa/questions/v2_OpenEnded_mscoco_train2014_questions.json",
            "valminusminival2014": "vqa/questions/v2_OpenEnded_mscoco_valminusminival2014_questions.json",
            "val2014": "vqa/questions/v2_OpenEnded_mscoco_val2014_questions.json",
            "minival2014": "vqa/questions/v2_OpenEnded_mscoco_minival2014_questions.json",
            "test-dev2015": "vqa/questions/v2_OpenEnded_mscoco_test-dev2015_questions.json",
            "test2015": "vqa/questions/v2_OpenEnded_mscoco_test2015_questions.json",
        }
        vqa_annot = {
            "train2014": "vqa/annotations/v2_mscoco_train2014_annotations.json",
            "valminusminival2014": "vqa/annotations/v2_mscoco_valminusminival2014_annotations.json",
            "val2014": "vqa/annotations/v2_mscoco_val2014_annotations.json",
            "minival2014": "vqa/annotations/v2_mscoco_minival2014_annotations.json",
        }
        vqa_imdb = {
        ...
        if boxes == "36":
            precomputed_boxes = {
                'train2014': ("mscoco/mscoco_imgfeat/vl-bert", "trainval_obj36-36"),
                "valminusminival2014": ("mscoco/mscoco_imgfeat/vl-bert", "trainval_obj36-36"),
                'val2014': ("mscoco/mscoco_imgfeat/vl-bert", "trainval_obj36-36"),
                "minival2014": ("mscoco/mscoco_imgfeat/vl-bert", "trainval_obj36-36"),
                "test-dev2015": ("mscoco/mscoco_imgfeat/vl-bert", "test2015_obj36-36"),
                "test2015": ("mscoco/mscoco_imgfeat/vl-bert", "test2015_obj36-36"),
            }
        ...
        coco_dataset = {
            "train2014": ("train2014", "mscoco/annotations/instances_train2014.json"),
            "valminusminival2014": ("val2014", "mscoco/annotations/instances_val2014.json"),
            "val2014": ("val2014", "mscoco/annotations/instances_val2014.json"),
            "minival2014": ("val2014", "mscoco/annotations/instances_val2014.json"),
            "test-dev2015": ("test2015", "mscoco/annotations/image_info_test2015.json"),
            "test2015": ("test2015", "mscoco/annotations/image_info_test2015.json"),
        }
    ...
    def __getitem__(self, index):
        ...
        if self.with_precomputed_visual_feat:
            ...
            boxes_features = torch.as_tensor(
                np.frombuffer(self.b64_decode(boxes_data['features']), dtype=np.float32).reshape((int(boxes_data['num_boxes']), -1))
            )
        else:
