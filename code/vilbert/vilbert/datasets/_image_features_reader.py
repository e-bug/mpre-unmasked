...
class ImageFeaturesH5Reader(object):
    ...
    def __getitem__(self, image_id):
        ...
        #print(str(image_id).encode(), type(str(image_id).encode()))
        #print(self._image_ids[0], type(self._image_ids[0]))
        #print(self._image_ids)
        image_id = str(image_id).encode()
        #with open('/home/4/19ITA380/projects/mpre-zeroshot/code/vilbert/run/snli_ve/image.ids', 'w') as f:
        #    f.write(str(self._image_ids))
        #print(image_id)
