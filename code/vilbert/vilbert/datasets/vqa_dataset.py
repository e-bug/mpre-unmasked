...
def _load_dataset(dataroot, name, clean_datasets):
    ...
    if name == "train" or name == "val":
        question_path = os.path.join(
            dataroot, "questions", "v2_OpenEnded_mscoco_%s2014_questions.json" % name
        )
        questions = sorted(
        ...
        question_path_train = os.path.join(
            dataroot, "questions", "v2_OpenEnded_mscoco_%s2014_questions.json" % "train"
        )
        ...
        question_path_val = os.path.join(
            dataroot, "questions", "v2_OpenEnded_mscoco_%s2014_questions.json" % "val"
        )
        ...
        question_path_test = os.path.join(
            dataroot, "questions", "v2_OpenEnded_mscoco_%s2015_questions.json" % "test"
        )
