    ...
    def __init__(
        ...
        if dist.is_available() and local_rank != -1:
            ...
            lmdb_file = os.path.join(
                corpus_path, "vilbert/training_feat_part_" + str(rank) + ".lmdb"
            )
        else:
            lmdb_file = os.path.join(corpus_path, "volta/training_feat_all.lmdb") # "vilbert/training_feat_all.lmdb")
...
class ConceptCapLoaderVal(object):
    ...
    def __init__(
        ...
        lmdb_file = os.path.join(corpus_path, "volta/validation_feat_all.lmdb") #"vilbert/validation_feat_all.lmdb")
        caption_path = os.path.join(corpus_path, "caption_valid.json")
        print("Loading from %s" % lmdb_file)
...
# FIXME above is right
        image_feature_wp, image_target_wp, obj_labels, _, _, _, _, \
...
class ConceptCapLoaderRetrieval(object):
    ...
    def __init__(
        ...
        caption_path = "/coc/pskynet2/jlu347/multi-modal-bert/data/conceptual_caption/caption_valid.json"
