...
def _load_dataset(dataroot):
    ...
    with jsonlines.open(annotations_path) as reader:
        ...
        for annotation in reader:
            ...
            dictionary["image_id_0"] = annotation["identifier"] + "-img0"
            dictionary["image_id_1"] = annotation["identifier"] + "-img1"
...
class NLVR2ContrastSetDataset(Dataset):
    def __init__(
        self,
        task,
        dataroot,
