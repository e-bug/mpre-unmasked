...
from utils import load_obj_tsv, load_obj_json

TINY_IMG_NUM = 500
FAST_IMG_NUM = 5000

BASEDIR = '/gs/hs0/tgb-deepmt/bugliarello.e/data/conceptual_captions/'
...
Split2ImgFeatPath = {
    ...
    'concap_train': BASEDIR + 'lxmert/train_obj36-36.clean/',
    'concap_valid': BASEDIR + 'lxmert/valid_obj36-36.clean/',
}
...
#                used_data.append(datum)
        ...
        source = self.raw_dataset.sources[0]
        self.data = []
        for datum in self.raw_dataset.data:
            sentf = datum['sentf']
            for sents_cat, sents in sentf.items():
                ...
                for sent_idx, sent in enumerate(sents):
                    new_datum = {
                        ...
                        'img_id': datum['img_id'],
                        'sent': sent,
                        'img_fn': Split2ImgFeatPath[source] + datum['img_id'] + '.json',
                    }
    ...
    def random_feat(self):
        ...
        img_id = datum['img_id']
        img_info = load_obj_json(datum['img_fn'])
