...
ANNOTAT_ROOT = '/gs/hs0/tgb-deepmt/bugliarello.e/data/gqa/lxmert'
IMGFEAT_ROOT = '/gs/hs0/tgb-deepmt/bugliarello.e/data/gqa/vg_gqa_imgfeat/'
...
class GQADataset:
    ...
    def __init__(self, splits: str):
        ...
        # Answers
        self.ans2label = json.load(open(os.path.join(ANNOTAT_ROOT, "trainval_ans2label.json")))
        self.label2ans = json.load(open(os.path.join(ANNOTAT_ROOT, "trainval_label2ans.json")))
