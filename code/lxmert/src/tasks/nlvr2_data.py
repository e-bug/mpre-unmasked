...
ANNOTAT_ROOT = '/gs/hs0/tgb-deepmt/bugliarello.e/data/nlvr2/lxmert'
IMGFEAT_ROOT = '/gs/hs0/tgb-deepmt/bugliarello.e/data/nlvr2/nlvr2_imgfeat/'
...
class NLVR2Dataset:
    ...
    def __init__(self, splits: str):
        ...
        for split in self.splits:
            self.data.extend(json.load(open(os.path.join(ANNOTAT_ROOT, "%s.json" % split))))
...
#            img_data.extend(load_obj_tsv('data/nlvr2_imgfeat/test_obj36.tsv', topk=topk))
        img_data.extend(load_obj_tsv(os.path.join(IMGFEAT_ROOT, "nlvr2_obj36-36.tsv"), topk=topk))
        self.imgid2img = {}
        ...
        for datum in self.raw_dataset.data:
            if datum['img0'] in self.imgid2img and datum['img1'] in self.imgid2img:
                ...
                split_imgids.add(datum['img0'])
                split_imgids.add(datum['img1'])
        self.imgid2img = {k: v for k, v in self.imgid2img.items() if k in split_imgids}
        print("Use %d data in torch dataset" % (len(self.data)))
        print("Use %d images in torch dataset" % (len(self.imgid2img)))
        print()
