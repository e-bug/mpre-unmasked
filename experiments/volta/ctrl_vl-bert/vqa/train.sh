...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/vqa/volta/ctrl_vl-bert \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/vqa \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/vqa/volta/ctrl_vl-bert/VQA_ctrl_vl-bert_base/pytorch_ckpt_latest.tar
