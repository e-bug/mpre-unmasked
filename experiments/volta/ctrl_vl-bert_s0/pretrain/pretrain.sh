...
python train_concap.py \
	...
	--num_train_epochs 10 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions_s${seed}/volta/ctrl_${model}/ctrl_${model}_base/pytorch_ckpt_8.tar
