...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/ctrl_vil_uniter \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/nlvr2 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/ctrl_vil_uniter/NLVR2_ctrl_vil_uniter_base/pytorch_ckpt_latest.tar
