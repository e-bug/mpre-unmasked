...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/flickr30k/volta/ctrl_uniter \
        --logdir ../../logs/volta/flickr30k \
#	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/flickr30k/volta/ctrl_uniter/RetrievalFlickr30k_ctrl_vilbert_base/pytorch_ckpt_latest.tar
