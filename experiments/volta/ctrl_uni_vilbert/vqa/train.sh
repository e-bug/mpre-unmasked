...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/vqa/volta/ctrl_uni_vilbert \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/vqa \
#	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/vqa/volta/ctrl_uni_vilbert/VQA_ctrl_uni_vilbert_base/pytorch_ckpt_latest.tar
