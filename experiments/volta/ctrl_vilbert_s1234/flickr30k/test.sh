...
python eval_retrieval.py \
        ...
        --from_pretrained /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/flickr30k/volta/ctrl_${model}_s${seed}/RetrievalFlickr30k_ctrl_${model}_base/pytorch_model_17.bin \
