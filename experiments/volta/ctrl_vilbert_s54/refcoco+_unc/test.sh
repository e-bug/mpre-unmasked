...
python eval_task.py \
        ...
        --from_pretrained /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcoco+_unc/volta/ctrl_${model}_s${seed}/refcoco+_ctrl_${model}_base/pytorch_model_16.bin \
        --task 10 \
