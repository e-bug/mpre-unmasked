...
python eval_task.py \
        ...
        --from_pretrained /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcoco+_unc/volta/ctrl_lxmert_s${seed}/refcoco+_ctrl_lxmert/pytorch_model_19.bin \
        --task 10 \
