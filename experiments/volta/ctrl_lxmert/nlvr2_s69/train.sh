...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2_s69/volta/ctrl_lxmert \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/nlvr2_s69 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2_s69/volta/ctrl_lxmert/NLVR2_ctrl_lxmert/pytorch_ckpt_latest.tar
