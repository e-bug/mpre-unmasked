...
python train_concap.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions_s${seed}/volta/ctrl_lxmert \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/conceptual_captions_s${seed} \
	--num_train_epochs 10 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions_s${seed}/volta/ctrl_lxmert/ctrl_lxmert/pytorch_ckpt_6.tar
