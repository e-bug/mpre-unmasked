...
python train_tasks.py \
        ...
        --output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcoco_unc/volta/vilbert \
        --logdir ../../logs/volta/refcoco_unc \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcoco_unc/volta/vilbert/refcoco_vilbert_base/pytorch_ckpt_latest.tar
