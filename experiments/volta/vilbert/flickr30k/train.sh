...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/flickr30k/volta/vilbert \
        --logdir ../../logs/volta/flickr30k \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/flickr30k/volta/vilbert/RetrievalFlickr30k_vilbert_base/pytorch_ckpt_latest.tar
