...
python train_tasks.py \
        ...
        --output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcoco+_unc/volta/vilbert \
        --logdir ../../logs/volta/refcoco+_unc \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcoco+_unc/volta/vilbert/refcoco+_vilbert_base/pytorch_ckpt_latest.tar
