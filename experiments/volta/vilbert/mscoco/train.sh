...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/mscoco/volta/vilbert \
        --logdir ../../logs/volta/mscoco \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/mscoco/volta/vilbert/RetrievalCOCO_vilbert_base/pytorch_ckpt_latest.tar
