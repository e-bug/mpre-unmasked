...
python train_tasks.py \
        ...
        --output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcocog_umd/volta/vilbert \
        --logdir ../../logs/volta/refcocog_umd \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/refcocog_umd/volta/vilbert/refcocog_vilbert_base/pytorch_ckpt_latest.tar
