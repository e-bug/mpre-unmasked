...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/snli_ve/volta/vilbert \
        --logdir ../../logs/volta/snli_ve \
#	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/snli_ve/volta/vilbert/VisualEntailment_vilbert_base/pytorch_ckpt_latest.tar
