...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/vilbert \
        --logdir ../../logs/volta/nlvr2 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/vilbert/NLVR2_vilbert_base/pytorch_ckpt_latest.tar
