...
python train_concap.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions_s0/volta/ctrl_lxmert \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/conceptual_captions_s0 \
	--num_train_epochs 10 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions_s0/volta/ctrl_lxmert/ctrl_lxmert/pytorch_ckpt_5.tar
