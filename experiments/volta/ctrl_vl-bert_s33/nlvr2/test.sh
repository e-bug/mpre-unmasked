...
python eval_task.py \
	...
	--from_pretrained /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/ctrl_${model}_s${seed}/NLVR2_ctrl_${model}_base/pytorch_model_12.bin \
	--task 12 \
