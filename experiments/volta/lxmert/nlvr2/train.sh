...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/lxmert \
        --logdir ../../logs/volta/nlvr2 \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/nlvr2/volta/lxmert/NLVR2_lxmert/pytorch_ckpt_latest.tar
