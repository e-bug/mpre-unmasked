...
python train_concap.py \
	--bert_model bert-base-uncased --config_file config/lxmert.json \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions/volta/lxmert \
        --logdir ../../logs/volta/conceptual_captions \
	--start_epoch 0 \
	--num_train_epochs 20 \
#        --resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/conceptual_captions/volta/lxmert/lxmert/pytorch_ckpt_17.tar \
