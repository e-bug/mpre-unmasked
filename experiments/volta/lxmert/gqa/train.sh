...
python train_tasks.py \
        ...
        --output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/gqa/volta/lxmert \
        --logdir /gs/hs0/tgb-deepmt/bugliarello.e/logs/volta/gqa \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/mpre-unmasked/gqa/volta/lxmert/GQA_lxmert/pytorch_ckpt_latest.tar
