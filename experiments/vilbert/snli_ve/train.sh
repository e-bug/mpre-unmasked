...
python train_tasks.py \
	...
	--output_dir /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/snli_ve/vilbert \
	--resume_file /gs/hs0/tgb-deepmt/bugliarello.e/checkpoints/snli_ve/vilbert/VisualEntailment_bert_base_6layer_6conect/pytorch_ckpt_latest.tar
